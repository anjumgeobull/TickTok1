...
public class UpdatePofileWithoutPicSP {
    private  final UpdateProfileWithoutPicService updateProfileServicepic;

    public UpdatePofileWithoutPicSP(Context context) {
        updateProfileServicepic = APIServiceFactory.createService(UpdateProfileWithoutPicService.class, context);
    }

    public  void CallUpdateProfileWithoutPic(RequestBody id, RequestBody mobile_number,
                                   RequestBody name, RequestBody email, RequestBody district, RequestBody state,
                                   ...
                                   RequestBody other, final APICallback apiCallback)
    {
        ...
        call = updateProfileServicepic.updateProfilewithoutpic(id,mobile_number,name,email,district,state,country,insta_id,facebook_id,youtube_id,other);
