...
import com.efunhub.ticktok.filter.GlBitmapOverlaySample;
import com.efunhub.ticktok.utility.GlWatermarkFilter;
...
public enum FilterType {
    ...
    public static GlFilter createGlFilter(FilterType filterType, Context context) {
        switch (filterType) {
            ...
            case WATERMARK:
               Bitmap bitmapNormal= BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_happyface);
                Bitmap scaledBitmap = Bitmap.createScaledBitmap(bitmapNormal, 50, 40, true);
                return new com.efunhub.ticktok.utility.GlWatermarkFilter(scaledBitmap, GlWatermarkFilter.Position.LEFT_TOP);
            case WEAK_PIXEL:
